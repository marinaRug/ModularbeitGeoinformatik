...
class DijkstraAlgorithmusGui:
    ...
    def starte_grafische_benutzeroberflaeche(self):
        ...
        fenster.title("Dijkstra - Kürzester Weg")
    ...
    def fuege_grafische_elemente_hinzu(self, frame):
        ...
        punkt2 = Label(frame, text="P2: [670765.75, 5256474.50]", bg='#283634', fg='#F0F3EB')
        punkt3 = Label(frame, text="P3: [670534.25, 5256568.00]", bg='#283634', fg='#F0F3EB')
        punkt4 = Label(frame, text="P4: [670506.50, 5256470.25]", bg='#283634', fg='#F0F3EB')
        punkt5 = Label(frame, text="P5: [670476.75, 5256482.00]", bg='#283634', fg='#F0F3EB')
        punkt6 = Label(frame, text="P6: [670436.75, 5256422.00]", bg='#283634', fg='#F0F3EB')
        punkt7 = Label(frame, text="P7: [670387.25, 5256441.25]", bg='#283634', fg='#F0F3EB')
        punkt8 = Label(frame, text="P8: [670423.25, 5256520.75]", bg='#283634', fg='#F0F3EB')
        punkt9 = Label(frame, text="P9: [670329.00, 5256471.50]", bg='#283634', fg='#F0F3EB')
        punkt10 = Label(frame, text="P10: [670371.75, 5256674.75]", bg='#283634', fg='#F0F3EB')
        punkt11 = Label(frame, text="P11: [670420.50, 5256673.50]", bg='#283634', fg='#F0F3EB')
        punkt12 = Label(frame, text="P12: [670420.25, 5256761.25]", bg='#283634', fg='#F0F3EB')
        punkt13 = Label(frame, text="P13: [670503.75, 5256750.00]", bg='#283634', fg='#F0F3EB')
        punkt14 = Label(frame, text="P14: [670551.50, 5256691.50]", bg='#283634', fg='#F0F3EB')

        startpunkt = Entry(frame, bd=5, width=20)
        startpunkt_label = Label(frame, text="Startpunkt:", bg='#283634', fg='#F0F3EB')
        zielpunkt = Entry(frame, bd=5, width=20)
        zielpunkt_label = Label(frame, text="Zielpunkt:", bg='#283634', fg='#F0F3EB')
